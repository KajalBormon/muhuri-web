...
use App\Http\Controllers\API\DepartureReasonController;
    ...
    Route::middleware(['api.key', 'throttle:api'])->group(function () {
        Route::prefix('muhuri-web')->group(function () {
            ...
            Route::prefix('sync')->group(function () {
                ...
                Route::prefix('tenant-permissions')->group(function() {
                    Route::post('/', [PermissionController::class,'syncTenantPermissions']);
                    Route::delete('/', [PermissionController::class,'syncTenantPermissionDelete']);
                });
                Route::prefix('tenant-roles')->group(function() {
                    Route::post('/', [RoleController::class,'syncTenantRoles']);
                    Route::delete('/', [RoleController::class,'syncTenantRoleDelete']);
                });
                Route::prefix('departure-reasons')->group(function(){
                    Route::post('/', [DepartureReasonController::class, 'syncDepartureReasons']);
                    Route::delete('/', [DepartureReasonController::class, 'departureReasonDelete']);
                });
