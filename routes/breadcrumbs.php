...
// Buyer Payment
Breadcrumbs::for('buyerPayment', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.buyerPayment'));
});

// Supplier Due
Breadcrumbs::for('supplierDue', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.supplierDue'));
});

// Supplier Payment
Breadcrumbs::for('supplierPayment', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.supplierPayment'));
});
...
// Sale By Brand
Breadcrumbs::for('saleByBrand', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.saleByBrand'));
});

// Purchase
Breadcrumbs::for('purchase', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.purchase'));
});

// Expense
Breadcrumbs::for('expense', function (BreadcrumbTrail $trail) {
    $trail->parent('report');
    $trail->push(__('breadcrumb.custom.report.childInfo.expense'));
});
...
Breadcrumbs::for('departureReasons', function (BreadcrumbTrail $trail) {
    $trail->parent('employee');
    $trail->push(__('breadcrumb.custom.departureReason.childInfo'), route('departure-reasons.index'));
});
