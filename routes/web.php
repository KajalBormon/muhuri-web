...
use App\Http\Controllers\HR\DepartureReasonController;
...
Route::middleware(Language::class)
    ->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::prefix('buyers/{buyer}')->name('buyers.payments.')->group(function(){
                Route::get('payments/{payment}/invoice', [BuyerPaymentController::class,'show'])->name('invoice');
                Route::post('addWaiver/', [BuyerPaymentController::class,'addWaiverPayment'])->name('addWaiver');
                Route::patch('waiverPayments/{payment}', [BuyerPaymentController::class,'updateWaiverPayment'])->name('updateWaiver');
            });
            ...
            Route::get('/suppliers/{supplier}/payments/{payment}/invoice', [SupplierPaymentController::class,'show'])->name('suppliers.payments.invoice');
            ...
            Route::prefix('reports')->name('reports.')->group(function() {
                ...
                Route::get('/buyer-payment', [ReportController::class, 'getBuyerPayment'])->name('buyerPayment');
                Route::get('/supplier-due', [ReportController::class, 'getSupplierDue'])->name('supplierDue');
                Route::get('/supplier-payment', [ReportController::class, 'getSupplierPayment'])->name('supplierPayment');
                Route::get('/sale', [ReportController::class, 'getSaleReport'])->name('sale');
                Route::get('/purchase', [ReportController::class, 'getPurchaseReport'])->name('purchase');
                Route::get('/expense', [ReportController::class, 'getExpenseReport'])->name('expense');
                Route::get('/brand-with-sale', [ReportController::class, 'getSalesByBrandReport'])->name('salesByBrand');
            });
