...
class BuyerSummaryService extends BaseModelService
{
    ...
    public function decreaseTotalTransactionForSaleItem(Buyer $buyer, $saleItem)
    {
        $buyerSummary = $this->firstOrCreateBuyerSummary($buyer, $saleItem->sale->sale_date);
        $buyerSummary->total_transaction -= $saleItem->total_price;
        $buyerSummary->save();
    }
}
