...
class SupplierSummaryService extends BaseModelService
{
    ...
    public function decreaseTotalTransactionForPurchaseItem(Supplier $supplier, $purchaseItem)
    {
        $buyerSummary = $this->firstOrCreateSupplierSummary($supplier, $purchaseItem->purchase->purchase_date);
        $buyerSummary->total_transaction -= $purchaseItem->total_price;
        $buyerSummary->save();
    }
}
