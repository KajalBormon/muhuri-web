                                        ...
                                        <tr v-for="(sale, index) in tableData" :key="sale.id">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    />
                                                    <DeleteConfirmationButton v-if="checkPermission('can-delete-sale')" iconClass="fs-3" title="Sale Item"  confirmRoute="sales.saleItems.destroy" :saleId="props?.sale?.id" :saleItem="sale" :messageTitle="`${$t('confirmation.saleItem.delete', { saleItem: sale.item_name})}`"/>
                                                </div>
                                            </td>
                                        </tr>
    ...
    if (props.sale) {
        ...
        tableData.value = props.sale?.sale_items.map((sale: any) => {
            ...
            return {
                ...
                total_box: sale?.total_box || 0,
                total_poly: sale?.total_poly || 0,
                mir: sale?.mir || 0,
