                                        ...
                                        <tr v-for="(purchase, index) in tableData" :key="purchase.id">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    />
                                                    <DeleteConfirmationButton v-if="checkPermission('can-delete-other-purchase')" iconClass="fs-3" title="Purchase Item"  confirmRoute="purchases.purchaseItems.destroy" :purchaseId="props?.purchase?.id" :purchaseItem="purchase" :messageTitle="`${$t('confirmation.purchaseItem.delete', { purchaseItem: purchase.item_name})}`"/>
                                                </div>
                                            </td>
                                        </tr>
                                        <!-- Total Amount -->
