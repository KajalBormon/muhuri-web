...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'departureReason' => [
            'store' => [
                'success' => 'New Departure Reason created successfully',
                'error' => 'New Departure Reason could not be created'
            ],
            'update' => [
                'success' => 'Departure Reason updated successfully',
                'error' => 'Departure Reason could not be updated'
            ],
            'destroy' => [
                'success' => 'Departure Reason deleted successfully',
                'error' => 'Departure Reason could not be deleted'
            ],
            'changeStatus' => [
                'activate' => 'Departure Reason is activated',
                'deactivate' => 'Departure Reason is deactivated',
                'error' => 'Departure Reason status could not be changed'
            ]
        ],
        ...
        'payment' => [
            ...
            'update' => [
                ...
                'invalid' => 'This Sale Payment is not Updated'
            ],
            'destroy' => [
                'success' => 'Payment is deleted successfully',
                'error' => 'Payment could not be deleted',
                'invalid' => 'This Sale Payment is not deleted'
            ]
        ],
        ...
        'saleItem' => [
           'destroy' => [
                'success' => 'Sale item is deleted successfully',
                'error' => 'Sale item could not be deleted'
            ],
        ],
        ...
        'purchaseItem' => [
            'destroy' => [
                'success' => 'Purchase item is deleted successfully',
                'error' => 'Purchase item could not be deleted'
            ],
        ],
        ...
        'expense' => [
            ...
            'update' => [
                'success' => 'Expense is updated successfully',
